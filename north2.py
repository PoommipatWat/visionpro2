...
conv1 = Conv2D(128, kernel_size=(3, 3), activation='relu')(inputIm)
pool1 = MaxPool2D(pool_size=(3, 3))(conv1)
conv2 = Conv2D(256, kernel_size=(3, 3), activation='relu')(pool1)
pool2 = MaxPool2D(pool_size=(2, 2))(conv2)
conv3 = Conv2D(512, kernel_size=(3, 3), activation='relu')(pool2)
pool3 = MaxPool2D(pool_size=(2, 2))(conv3)
conv4 = Conv2D(1024, kernel_size=(3, 3), activation='relu')(pool3)
...
dense3 = Dense(128, activation='relu')(dropout1)
